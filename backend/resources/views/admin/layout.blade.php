      ...
      <nav class="p-3 space-y-1 text-sm flex-1 overflow-y-auto">
        ...
        <details class="group" @if(request()->routeIs('admin.products.*') || request()->routeIs('admin.categories.*') || request()->routeIs('admin.catalog.*')) open @endif>
          ...
          <div class="ml-4 mt-1 pl-3 border-l border-line space-y-1">
            ...
            <a href="{{ route('admin.catalog.in_house') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.in_house') ? $childActive : $childIdle }}">In House Products</a>
            <a href="{{ route('admin.catalog.digital') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.digital') ? $childActive : $childIdle }}">Add New Digital Product</a>
            <a href="{{ route('admin.catalog.seller') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.seller') ? $childActive : $childIdle }}">Seller Product</a>
            <a href="{{ route('admin.catalog.import') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.import') ? $childActive : $childIdle }}">Bulk Import</a>
            <a href="{{ route('admin.catalog.export') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.export') ? $childActive : $childIdle }}">Bulk Export</a>
            ...
            <a href="{{ route('admin.catalog.brands') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.brands') ? $childActive : $childIdle }}">Brand</a>
            <a href="{{ route('admin.catalog.labels') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.labels') ? $childActive : $childIdle }}">Custom Label</a>
            <a href="{{ route('admin.catalog.attributes') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.attributes') ? $childActive : $childIdle }}">Attribute</a>
            <a href="{{ route('admin.catalog.colors') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.colors') ? $childActive : $childIdle }}">Colors</a>
            <a href="{{ route('admin.catalog.size_guides') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.size_guides') ? $childActive : $childIdle }}">Size Guide</a>
            <a href="{{ route('admin.catalog.warranties') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.warranties') ? $childActive : $childIdle }}">Warranty</a>
            <a href="{{ route('admin.catalog.smart_bars') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.smart_bars') ? $childActive : $childIdle }}">Smart Bar</a>
            <a href="{{ route('admin.catalog.reviews') }}" class="block px-3 py-1.5 rounded-sm text-xs transition {{ request()->routeIs('admin.catalog.reviews') ? $childActive : $childIdle }}">Product Reviews</a>
          </div>
        </details>
